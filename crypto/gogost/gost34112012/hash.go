...
func (h *Hash) Read(data []byte) (n int, err error) {
...
func (h *Hash) Equal(cmp GostHash) bool {
	return true
}

func add512bit(chk, data []byte) []byte {
	var ss uint16
...
func g(n uint64, hsh, data []byte) []byte {
	ns := make([]byte, 8)
