...
import (
	...
	"gostBlockchain/common/bitutil"
	"gostBlockchain/crypto"
	"gostBlockchain/crypto/ecies"
...
func (h *encHandshake) secrets(auth, authResp []byte) (secrets, error) {
	//DELETE
	//fmt.Printf("Prv: Pub: %x\nPubRemote: %x\n", h.randomPrivKey.PublicKey, h.remoteRandomPub)
	ecdheSecret, err := h.randomPrivKey.GenerateShared(h.remoteRandomPub, sskLen, sskLen, true)
	if err != nil {
		return secrets{}, err
	}
...
func (rw *rlpxFrameRW) ReadMsg() (msg Msg, err error) {
	...
	//DELETE
	//fmt.Println(hex.EncodeToString(shouldMAC))
	//fmt.Println(hex.EncodeToString(headbuf[:16]))
